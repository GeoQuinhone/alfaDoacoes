...
return [
    ...
    | pela classe de validação. Sinta-se à vontade para ajustar cada uma dessas mensagens.
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | As seguintes linhas de idioma são usadas para trocar o nome do campo
    | pelo nome mais "amigável" que o usuário vê. Por exemplo, em vez de
    | "email" exibir "Endereço de E-mail".
    |
    */
